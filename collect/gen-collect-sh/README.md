...
* Does not generate `processes.json` (processes module), but same information can always be collected with `commands` module. CollectiFOR viewer will not shouw process information in `/processes` view.
